      ...
      <div class="card-body">
        <div class="panel-body">
          <table width="100%" class="table table-bordered table-hover" id="dataTables-example">
            ...
            <?php
              $queri="Select * From tb_mahasiswa";
                    ...
                    echo "      
                        ...
                        <td>".$data[0]."</td>  
                            <td>".$data[1]."</td>
                                  ...
                                  <td>".$data[3]."</td>
                                  <td>".$data[4]."</td>
                                  <td><a href=\"edatamahasiswa.php?id=".$data[0]."\">Edit Data</a> "." &nbsp; &nbsp;<a href=\"delete.php?id=".$data[0]."\" onclick='return checkDelete()'>Hapus Data</a> </td>
                                  </tr>   
                        ";      
                    }
              ?>
