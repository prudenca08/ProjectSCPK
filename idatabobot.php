    ...
    <div class="card shadow m-5">
      ...
      <div class="card-body">
        <form name="frm" id="myForm" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="col">
              <input type="text" name="tugas" class="form-control" data-error="Isi kolom dengan benar">
              <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
              <div class="help-block with-errors" role="alert"></div>
            </div>
          </div>
      ...
      <div class="card-footer">
        ...
        <?php
                    ...
                    $query="INSERT INTO tb_bobot SET B_UAS='$uas', B_UTS='$uts', B_nilaitugas='$tugas', B_tesmasuk='$tes'";
